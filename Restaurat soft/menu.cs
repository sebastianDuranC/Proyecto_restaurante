    ...
    { private Timer ti, ti2;
            ...
            { 
                ...
                foreach (DataGridViewRow item in grid.Rows)
                {
                    if (item.Cells[0].Value.ToString() == wdg.id)
                    {
                        ...
                        item.Cells[2].Value = (double.Parse(item.Cells[1].Value.ToString()) *
                                                       double.Parse(item.Cells[2].Value.ToString().Replace("$", ""))).ToString("C2"); ;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (grid.Rows.Count > 0)
            {
               MetodoPago F1= new MetodoPago();
                F1.texttotal.Text =this. lblPRECIO.Text;
                F1.Show();
                grid.Rows.Clear();
       ...
       public struct datos
        ...
        private void MENÚ_Shown(object sender, EventArgs e)
        {
            ...
            AddItems("Locro de Gallina - comida",10,10,categories.comida, "comida1.jpg");
